...
function Home() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_components_layout__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    getBeforeInit: function getBeforeInit(instance) {
      instance.type("I'm a Software Engineer").pause(350)["delete"](19).pause(300).type("Senegalese").pause(300)["delete"](10).pause(300).type("a Student").pause(300)["delete"](9).pause(300).type("a Hacker").pause(300)["delete"](8).pause(300).type("an Anime addict").go();
      return instance;
    },
    __self: this,
    __source: {
...
//# sourceMappingURL=index.js.7e75af121a060f6ad9fd.hot-update.js.map