...
function Home() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_components_layout__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    getBeforeInit: function getBeforeInit(instance) {
      instance.type(" a Software Engineer").pause(350)["delete"](19).pause(300).type("Senegalese").pause(300)["delete"](10).pause(300).type("a Student").pause(300)["delete"](9).pause(300).type("a Hacker").pause(300)["delete"](8).pause(300).type("an Anime addict");
      return instance;
    },
    __self: this,
    __source: {
...
//# sourceMappingURL=index.js.335ee0352297a723b704.hot-update.js.map