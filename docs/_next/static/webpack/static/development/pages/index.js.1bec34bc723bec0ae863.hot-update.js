...
function Home() {
  ...
  }, "Hello! My name is Ali, I'm", __jsx(typeit_react__WEBPACK_IMPORTED_MODULE_5__["default"], {
    options: {
      lifelike: true,
      loop: true
    },
    getBeforeInit: function getBeforeInit(instance) {
      instance.type(" a Software Engineer").pause(350)["delete"](19).pause(300).type("Senegalese").pause(300)["delete"](10).pause(300).type("a Student").pause(300)["delete"](9).pause(300).type("a Hacker").pause(300)["delete"](8).pause(300).type("an Anime addict").go();
      return instance;
    },
    __self: this,
    __source: {
...
//# sourceMappingURL=index.js.1bec34bc723bec0ae863.hot-update.js.map